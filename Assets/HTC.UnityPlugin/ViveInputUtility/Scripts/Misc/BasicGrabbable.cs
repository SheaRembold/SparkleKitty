    ...
    , IColliderEventDragEndHandler
{
    ...
    private OrderedIndexedTable<ColliderButtonEventData, HTC.UnityPlugin.PoseTracker.Pose> eventList = new OrderedIndexedTable<ColliderButtonEventData, HTC.UnityPlugin.PoseTracker.Pose>();
    ...
    private HTC.UnityPlugin.PoseTracker.Pose GetEventPose(ColliderButtonEventData eventData)
    {
        var grabberTransform = eventData.eventCaster.transform;
        return new HTC.UnityPlugin.PoseTracker.Pose(grabberTransform);
    }
#if UNITY_EDITOR
    ...
    public virtual void OnColliderEventDragStart(ColliderButtonEventData eventData)
    {
        ...
        var offsetPose = HTC.UnityPlugin.PoseTracker.Pose.FromToPose(casterPose, new HTC.UnityPlugin.PoseTracker.Pose(transform));
