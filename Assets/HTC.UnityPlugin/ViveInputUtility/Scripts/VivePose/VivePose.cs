...
namespace HTC.UnityPlugin.Vive
{
    ...
    public static partial class VivePose
    {
        ...
        private static readonly HTC.UnityPlugin.PoseTracker.Pose[] s_poses = new HTC.UnityPlugin.PoseTracker.Pose[OpenVR.k_unMaxTrackedDeviceCount];
        ...
        public static void Initialize()
        {
            ...
            if (system != null)
            {
                OnInputFocus(system.IsInputAvailable());
            }
            else
            {
                OnInputFocus(true);
        ...
        private static void OnCameraPreCull(Camera cam)
        {
            ...
            for (int i = s_rawPoses.Length - 1; i >= 0; --i)
            {
                ...
                s_poses[i] = new HTC.UnityPlugin.PoseTracker.Pose(s_rawPoses[i].mDeviceToAbsoluteTracking);
            }
